 ...
 */
class getConseilRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ConseilRepository' shared autowired service.
     *
     * @return \App\Repository\ConseilRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ConseilRepository.php';

        return $container->privates['App\\Repository\\ConseilRepository'] = new \App\Repository\ConseilRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
