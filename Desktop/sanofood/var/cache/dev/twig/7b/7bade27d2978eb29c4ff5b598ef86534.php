...
class __TwigTemplate_73d1b5d4aa1a9dc67415e1c7e61a4c92 extends Template
{
...
";
    ...
    <div class=\"content\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["demande"]) {
            ...
            // line 84
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("delete_demande", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["demande"], "id", [], "any", false, false, false, 84)]), "html", null, true);
            yield "\">Supprimer</a>
                                                <a class=\"btn cur-p btn-success\" href=\"";
            // line 85
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("update_demande", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["demande"], "id", [], "any", false, false, false, 85)]), "html", null, true);
                                    ...
                                    <div class=\"card card-demande\">
                                        <div class=\"card-body\">
                                            ...
                                            <div class=\"demande-actions\">
                                                ...
                                                <a class=\"btn cur-p btn-success\" href=\"{{ path('update_demande', {'id': demande.id}) }}\">Mettre à jour</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
