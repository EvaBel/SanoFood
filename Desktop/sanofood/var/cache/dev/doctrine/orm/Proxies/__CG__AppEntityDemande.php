 ...
 */
class Demande extends \App\Entity\Demande implements \Doctrine\ORM\Proxy\InternalProxy
{
    ...
    private const LAZY_OBJECT_PROPERTY_SCOPES = [
        "\0".parent::class."\0".'conseils' => [parent::class, 'conseils', null],
        ...
        'conseils' => [parent::class, 'conseils', null],
